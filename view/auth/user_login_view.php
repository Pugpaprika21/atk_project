        ...
        <form id="auth-login">
            <div class="card-body">
                ...
                <div class="input-group flex-nowrap mt-4">
                    ...
                    <input type="password" class="form-control" id="password" placeholder="Password" aria-label="Password" aria-describedby="addon-wrapping">
                </div>
            </div>
            <a href="../../view/auth/user_register_view.php" class="text-decoration-none col d-flex justify-content-end" id="auth_register">ลงทะเบียน</a>
...
<script src="../../javascript/auth/user_login_view.js"></script>